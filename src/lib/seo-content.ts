export const seoContent = {
  homeWhyChoose: {
    title: "Pourquoi choisir Kode pour votre IPTV Maroc ?",
    paragraphs: [
  ...
  abonnementIntro:
    "Comparez nos tarifs IPTV Maroc 2026 et choisissez le pack adapté à vos écrans. Activation rapide sur WhatsApp, serveurs garantis et garantie 45 jours.",
  abonnementSeo: [
    "Le Pack Pro à 300 dhs/an convient aux utilisateurs mono-écran en HD/FHD. L'Expérience Ultra à 450 dhs/an débloque le 4K et deux appareils non simultanés. Le VIP à 600 dhs/an ajoute VPS, 4K UHD et trois appareils.",
  ...
  faqIntro:
    "FAQ IPTV Maroc Kode : compatibilité Smart TV / Firestick / Apple TV, applications (Nino Player, IPTV Smarters, IBO Player, XCIPTV), débits HD–4K, VPN, tarifs MAD et EUR, paiement WhatsApp, activation Xtream/M3U sous 5–30 min, et support 24/7. Réponses chiffrées pour utilisateurs et moteurs IA.",
  contactIntro:
    "Une question sur votre abonnement IPTV Maroc ? Contactez Kode par WhatsApp ou e-mail. Support 24/7, activation guidée et garantie 45 jours.",
  blogIntro:
    "Guides, comparatifs et conseils techniques pour choisir, installer et optimiser votre IPTV au Maroc avec Kode.",
};
